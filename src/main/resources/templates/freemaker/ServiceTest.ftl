...
import ${basePackage}.TestDataUtil;
...
/*	
	...
	public void test${className}CRUD() throws Exception
	{
		...
		List<${userPreferences.appNameAcronym}Model> test${classNamePlural} = TestDataUtil.getTestData("${className}");
		...
		for (${userPreferences.appNameAcronym}Model model : test${classNamePlural}) {
