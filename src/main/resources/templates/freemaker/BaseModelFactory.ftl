...
public class ${userPreferences.appNameAcronym}ModelFactory {

	public ${userPreferences.appNameAcronym}ModelFactory() {
		// TODO Auto-generated constructor stub
	}

	@SuppressWarnings({ "unchecked", "rawtypes" })
	public static Object createFromJSON(JSONObject jsonObject,
			Class<? extends ${userPreferences.appNameAcronym}Model> modelClass) throws Exception {
